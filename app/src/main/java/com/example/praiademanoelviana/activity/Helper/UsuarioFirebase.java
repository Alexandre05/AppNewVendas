...
import static com.example.praiademanoelviana.activity.Helper.ConfiruFirebase.getFirebaseAutenticacao;
...
public class UsuarioFirebase {
    ...
    public static FirebaseUser getUsuarioAtual() {
        FirebaseAuth usuario = ConfiruFirebase.getFirebaseAutenticacao();
